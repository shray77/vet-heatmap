...
const DISEASE_SECTIONS: { aliases: string[]; key: DiseaseKey }[] = [
  ...
  { aliases: ["трихинеллёз", "трихинеллез"], key: "other" }, // we don't have a specific key
  { aliases: ["варроатоз пчёл", "варроатоз пчел"], key: "other" },
  { aliases: ["нозематоз пчёл", "нозематоз пчел"], key: "other" },
  { aliases: ["весенняя виремия карпов"], key: "other" },
  { aliases: ["сальмонеллёз птицы", "сальмонеллез птицы"], key: "other" },
